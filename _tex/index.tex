...
\urlstyle{same}
\hypersetup{
  pdftitle={My Research Project},
  pdfauthor={Kamryn Mansfield; Second Author},
  pdfkeywords={Awesome, Research},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\journalname{Transportation Engineering}
...
\authors{Kamryn Mansfield\affil{1}, Second Author\affil{2,3}}
\affiliation{1}{University of
Tennessee, }\affiliation{2}{University, }\affiliation{3}{Something
else, }
\correspondingauthor{Kamryn Mansfield}{steve@curvenote.com}
...
\section{Data Section}\label{sec-data}
...
\section{Quarto Examples}\label{sec-examples}

\textsubscript{Source:
\href{https://KamrynMansfield.github.io/bus_stop_amenities_safety/index.qmd.html}{Article
Notebook}}
...
\subsection{Using citations}\label{using-citations}
...
Data are discussed in Section~\ref{sec-data}.
...
\subsection{Markdown Table}\label{markdown-table}
...
\pandocbounded{\includegraphics[keepaspectratio]{1_images/la-palma-map.png}}
...
\subsection{Using figure from embeded
notbook}\label{using-figure-from-embeded-notbook}
...
\textsubscript{Source:
\href{https://KamrynMansfield.github.io/bus_stop_amenities_safety/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
